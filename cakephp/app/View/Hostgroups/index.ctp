...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-3 hidden-xs"><?php echo $this->Paginator->sort('HostObjects.name1', __('Host')); ?></div>
	...
	<div class="row">
		...
		<?php foreach($hostgroups as $hostgroupMember): ?>
			...
			<div class="col-xs-12 col-sm-3 <?php echo $borderClass; ?> <?php echo $borderClass;?>_first">
				<a href="<?php echo Router::url(['controller' => 'Hosts', 'action' => 'details', $hostgroupMember['HostObjects']['object_id']]); ?>"><?php echo h($hostgroupMember['HostObjects']['name1']);?></a>
			</div>
