...
<section class="content-header hidden-sm hidden-md hidden-lg">
	<h1>
		...
		<small><?php echo __('Host checks'); ?></small>
	</h1>
</section>
		...
		<div class="box box-primary">
			<div class="box-header">
				<div class="col-sm-8 hidden-xs">
					<h3 class="pull-left"><i class="fa fa-ellipsis-h"></i> <?php echo __('Host checks of'); ?>
						<a href="<?php echo Router::url([
								'controller' => 'Hosts',
								'action' => 'details',
								$object['Objects']['object_id']
			...
			<div class="box-body">
				...
				<?php foreach($hostchecks as $key => $hostcheck): ?>
					<div class="col-xs-12 no-padding <?php echo ($key % 2 == 0)?'row-bg':'row-default'; ?>">

						<div class="col-md-2 hidden-xs">
							<?php
							$hoststate = $hostcheck['Hostcheck']['state'];
							if($hoststate > 2){
								$hoststate = 2;
							}
							?>
